  ...
  return (
    ...
    >
      ...
      <p>
        ...
        sports, watching soccer, and hanging out with friends. I also enjoy{" "}
        <span className="font-medium">learning new things</span>. I am currently
        learning about{" "}
        <span className="font-medium">mathematics and history</span>. I'm also
